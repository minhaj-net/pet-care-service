...
const ServiceCard = () => {
  ...
  return (
    <section className="py-16 bg-linear-to-b from-blue-50 via-pink-50 to-white">
          ...
          <SwiperSlide key={index}>
            <div  className="card bg-white shadow-lg rounded-2xl overflow-hidden transform transition-all duration-500 hover:-translate-y-2 animate__animated animate__fadeInUp h-[480px] flex flex-col">
              ...
              <div className="card-body text-center p-5 flex flex-col justify-between flex-grow">
                ...
                <Link to={`/service-details/${service.serviceId}`} className="btn bg-linear-to-r from-pink-400 to-orange-400 border-none text-white hover:scale-105 transition-transform mt-auto">
                  View Details
                </Link>
              </div>
            </div>
